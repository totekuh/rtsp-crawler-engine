...
# COUNTRIES = [{"country_code": "AF", "country_name": "Afghanistan"},
...
#              {"country_code": "JO", "country_name": "Jordan"}, {"country_code": "KZ", "country_name": "Kazakhstan"},
...
#              {"country_code": "MW", "country_name": "Malawi"}, {"country_code": "MY", "country_name": "Malaysia"},
...
#              {"country_code": "BL", "country_name": "Saint Bartholemy"},
...
print(f'Will go through {len(COUNTRIES)} number of countries in searching for exposed cameras')

print('Starting the main loop')
for country in COUNTRIES:
    country_code = country['country_code']
    print(f'Collecting the possible range of IP addresses of {country_code}/{country["country_name"]}')
    ...
    for subnet in subnets:
        print(f'Scanning {subnet} for the exposed RTSP services')
        output_file = f'{subnet}.txt'
        system(f'python3 -u rtsp-masscan.py --masscan {subnet} --output {output_file}')
        system(f'python3 -u rtsp-probe.py -bl {output_file} --import {options.import_endpoint}')
