...
if options.country_code:
    filtered_contries = [country for country in COUNTRIES if
                         country['country_code'].lower() == options.country_code.lower()]
else:
    filtered_contries = COUNTRIES
print(f'Will go through {len(filtered_contries)} number of countries in searching for exposed cameras')

for country in filtered_contries:
